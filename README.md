...
5. 替换为真实/脱敏 H300 Clean Zone 前，先用 [Stage 8 H300 synthetic-to-real gap register](docs/stage8/h300_synthetic_to_real_gap_register.md) 检查字段、脱敏、权限和证据缺口。
