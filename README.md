...
本仓库目前用于承载项目启动文档、调研材料、实验记录、接口规范和原型代码。阶段二已经跑通 Rerun 本地技术评测的最小闭环，阶段三已进入 simulation-first Physical AI 数据包设计，下一步将围绕自有数据包 schema、validator、Rerun adapter 和两个仿真样例制定实施计划。
